...
<div style="clear: both;"></div>
<h2 style="text-align: center; margin: 7px;">Ожидания</h2>


<div class="NetworkStatus" id="UN" style="min-height:fit-content">
<div id="jNST">
<div class="tr" style="display: flex">
<div class="td" style="text-align: right; width: 50%">Кол.в ожидании:</div>
<div class="td"><span id="un-quently_add_nodes"></span></div>
</div>
<div class="tr" style="display: flex">
<div class="td" style="text-align: right; width: 50%">Общее кол.нод:</div>
<div class="td"><span id="un-all_nodes"></span></div>
</div>
</div>


</div>
<div class="NetworkStatus" id="NS" style="display: none">
<div id="jNST_loading">
